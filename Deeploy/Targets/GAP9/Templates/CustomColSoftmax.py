...
class CustomColSoftmax(NodeTemplate):
    def alignToContext(self, ctxt: NetworkContext,
      ...
      in_net_Buffer._targetmemorylevel['CustomColSoftmax'] = 'L2'
      in_kk_Buffer._targetmemorylevel['CustomColSoftmax'] = 'L2'
      out_net_Buffer._targetmemorylevel['CustomColSoftmax'] = 'L2'
    ...
    def hoistTransientBuffers(self, ctxt: NetworkContext,
      ...
      ctxt.lookup(L1_edge_in_ping_buffer_name)._targetmemorylevel['CustomColSoftmax'] = "L1"
      ctxt.lookup(L1_edge_in_pong_buffer_name)._targetmemorylevel['CustomColSoftmax'] = "L1"
      ctxt.lookup(L1_edge_out_ping_buffer_name)._targetmemorylevel['CustomColSoftmax'] = "L1"
      ctxt.lookup(L1_edge_out_pong_buffer_name)._targetmemorylevel['CustomColSoftmax'] = "L1"
